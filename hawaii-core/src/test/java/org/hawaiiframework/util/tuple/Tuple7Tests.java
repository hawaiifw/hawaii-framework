 ...
 */
public class Tuple7Tests extends AbstractTupleTests {

    private Tuple7<Object1, Object2, Object3, Object4, Object5, Object6, Object7> tuple =
            Tuples.of(object1, object2, object3, object4, object5, object6, object7);

    @Test
    public void testSizeIs7() {
        assertThat(tuple.size(), is(7));
    }

    @Test
    public void testSetElement7() {
        tuple.setElement7(other7);
        assertThat(tuple.getElement7(), is(sameInstance(other7)));
    }
