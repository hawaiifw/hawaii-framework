...
public class ApiErrorResponseEnricher implements ErrorResponseEnricher {
   ...
   * {@inheritDoc}
   *
   * <p><strong>NOTE:</strong> This enricher only applies if throwable is an {@link ApiException}
   * and #errorResponseResource is an {@link ApiErrorResponseResource}.
   */
  @Override
  public void doEnrich(
    ...
    if (throwable instanceof ApiException
        && errorResponseResource instanceof ApiErrorResponseResource) {
      ApiException apiException = (ApiException) throwable;
      ApiErrorResponseResource responseResource = (ApiErrorResponseResource) errorResponseResource;
