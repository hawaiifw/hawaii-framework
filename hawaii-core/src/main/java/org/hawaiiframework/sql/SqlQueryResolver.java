...
public interface SqlQueryResolver {
    ...
    /**
     * Resolve the given sql query by name. <p>To allow for {@code SqlQueryResolver} chaining, a
     * {@code ViewResolver} should return {@code null} if a sql query with the given name is not
     * defined in it.
     *
